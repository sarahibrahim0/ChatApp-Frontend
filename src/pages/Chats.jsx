...
const Chats = () => {
  ...
  return (
    <div className="relative grid grid-flow-col grid-cols-5 h-screen bg-white dark:bg-licorice">

      {/* Sidebar */}
      <div className=" col-span-1 flex flex-col space-y-3 p-3 bg-english-violet-2 dark:bg-licorice text-gray-100 dark:text-gray-100 z-10">
      ...
      {/* Chat Area */}
      <div className="col-span-4 bg-white dark:bg-licorice z-10  ">
        <ChatDialogue />
      </div>
    </div>
  );
